...
<body>
    <div class="form">    
        <form action="register.php" method="POST">
            <label><b>Register To Coer-Library</b></label>  
            <hr class="first">
            <label><b>Coer-ID</b></label>    
            <input type="text" name="Coer-ID" placeholder="Coer-ID" required id="Coer-ID" class="float-left1">    
            <br><br>  
            <label><b>Email</b></label>    
            <input type="email" name="Email" placeholder="Email" required id="Eamil" class="float-left1">    
            <br><br>    
            ...
            <input type="Password" name="RePassword"  placeholder=" Re Type Password" required id="Repassword" class="float-left1">
            <br><br>   
            <button type="submit" name="login" value="login" id="register-button">create account</button> 
            <br><br>    
        </div>
</body>
</html>